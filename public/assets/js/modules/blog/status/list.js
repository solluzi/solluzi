$(function () {
  var dataTable = $('#status-list').DataTable({
    'processing': true,
    'serverSide': true,
    "searching": false,
    "paging": true,
    ...
    'columns': [
      {
        ...
        render: function (data, type, row) {
          return '<div class="btn-group">' +
            ...
            '    <a class="dropdown-item s-edit" id="' + row.id + '" href="javascript:;"><i class="far fa-edit icon-blue"></i>&nbsp;Editar</a>' +
            '    <a class="dropdown-item s-delete" id="' + row.id + '" href="javascript:;"><i class="far fa-trash-alt icon-red"></i>&nbsp;Excluir</a>' +
            '  </div>' +
            '</div>';
        }
      },
  ...
  $('body').on('click', 'a.s-edit', function () {
  ...
  $('body').on('click', 'a.s-delete', function () {
    const id = $(this).attr('id')
