$(function () {
  var dataTable = $('#person-type-list').DataTable({
    'processing': true,
    'serverSide': true,
    "searching": false,
    "paging": true,
    ...
    'columns': [
      {
        ...
        render: function (data, type, row) {
          return '<div class="btn-group">' +
            ...
            '    <a class="dropdown-item pt-edit" id="' + row.id + '" href="javascript:;"><i class="far fa-edit icon-blue"></i>&nbsp;Editar</a>' +
            '    <a class="dropdown-item pt-delete" id="' + row.id + '" href="javascript:;"><i class="far fa-trash-alt icon-red"></i>&nbsp;Excluir</a>' +
            '  </div>' +
            '</div>';
        }
      },
  ...
  $('body').on('click', 'a.pt-edit', function () {
  ...
  $('body').on('click', 'a.pt-delete', function () {
    const id = $(this).attr('id')
